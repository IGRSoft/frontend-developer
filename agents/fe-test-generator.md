...
Also invoked during the **QA** stage by `company-workflow:qa-engineer` for coverage-gap analysis. The QA gate is tests-pass **AND** axe-clean **AND** Lighthouse budget; this agent owns the tests-pass leg.
