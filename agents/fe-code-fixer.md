...
|-------|------|-------------|
| **DR** | Primary Support | Apply `igrsoft:technical-lead` findings from `.context/developer-review-N.md`; enforce minimal-diff; write retries to `.context/errors/fe-code-fixer.md` |
