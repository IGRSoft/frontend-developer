...
Also feeds the **QA** Lighthouse-budget leg of the gate (tests-pass AND axe-clean AND Lighthouse budget) — supplies the budget verdict as context to `igrsoft:qa-engineer`.
