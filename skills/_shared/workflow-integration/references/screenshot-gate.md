...
Web DV produces the manifest through corpflow's **`web_adapter`** capture path (Playwright / Chrome MCP rendered DOM) — already wired in `corpflow/agents/developer.md`'s Screenshot Capture table:
