...
| **workflow-integration** | [`_shared/workflow-integration/SKILL.md`](_shared/workflow-integration/SKILL.md) | Integrating with the igrsoft workflow system; DV screenshot gate via web_adapter, Lighthouse/axe supporting evidence |
